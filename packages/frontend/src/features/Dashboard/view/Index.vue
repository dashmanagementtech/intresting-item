...
<template>
  <section class="!h-[100vh]">
    ...
    <div v-loading="tasksAnalytics.loading" class="my-10 grid grid-cols-2 min-lg:grid-cols-4 gap-5">
      <div class="rounded-2xl border border-gray-50 p-5 flex justify-between">
        <div class="">
          <h2 class="text-lg font-semibold">
            {{ tasksAnalytics.total }}
          </h2>
          <p class="opacity-50">
            Total Tasks
          </p>
        ...
        <div class="inline-flex items-center justify-center py-3 px-3.5 rounded-full bg-[#2563EB]/20">
          <el-icon size="24" color="#2563EB">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M18.3332 10H14.9998L12.4998 17.5L7.49984 2.5L4.99984 10H1.6665" stroke="#2563EB"
    ...
    <el-scrollbar class="!h-[57vh] overflow-auto">
      <div class="my-10 grid min-lg:grid-cols-2 gap-5">
        <div class="rounded-2xl bg-white flex flex-col gap-5">
          ...
          <div v-loading="upcoming.loading" class="flex flex-col gap-3">
            <template v-if="upcoming?.items?.length !== 0">
              <div
                v-for="(task, key) in upcoming.items" :key
              ...
              >
                <div class="flex gap-3 items-start">
                  ...
                  <div class="flex flex-col">
                    <div>
                      <h3 class="font-[500] text-lg line-clamp-1">
                        {{ task?.title }}
                      </h3>
